...
List<ModelOption> get modelOptions => const [
  ModelOption(
    ...
    subtitle: 'OpenAI',
    description:
        'Sinema kalitesinde metinden video. Gerçekçi hareketler, fizik ve sahne tutarlılığı.',
  ...
  ModelOption(
    ...
    description:
        'Prodüksiyon seviyesinde 4K çıktılar, 60 fps ve kamera kontrolü.',
    mode: GenerationMode.textToVideo,
  ...
  ModelOption(
    ...
    name: 'Kling 2.5',
    subtitle: 'Kuaishou',
    description: 'Hızlı jenerasyon, sosyal medya odaklı kısa video üretimi.',
    mode: GenerationMode.textToVideo,
  ...
  ModelOption(
    ...
    subtitle: 'fal.ai',
    description:
        'Stable Video Diffusion tabanlı, görselden videoya dönüşüm. Giriş seviyesi için ideal.',
    mode: GenerationMode.textAndImage,
